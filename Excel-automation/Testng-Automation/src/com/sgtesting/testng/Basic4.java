...
private  void login(String name,String password)             
{
   ...
   @Test(priority=5,dataProvider="customermodiydetails")
private static void modifycustomer(String modifycustomer)
{
	try {
		...
		Thread.sleep(1000);
		obrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[1]/div[3]/div/div[2]/input")).sendKeys(modifycustomer);
		Thread.sleep(1000);
...
@DataProvider(name="customermodiydetails")
public Object[][] getcustomermodifyData()
{
	return new Object[][] {{"shanth2"}};
}
