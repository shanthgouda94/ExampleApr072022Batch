...
public class Scenario4 {
	...
	public static void modifyCustomer()
	{
		try {
			...
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickoncustomername")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickonblankspace")).clear();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickonblankspace")).sendKeys("State Bank of India");
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickoncustomerfile")).click();
			Thread.sleep(2000);
