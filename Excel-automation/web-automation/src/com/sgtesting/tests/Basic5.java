...
public class Basic5 {
	...
	private static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("custome1");
	...
	private static void createProject()
	{
		try
		{
			...
			oBrowser.findElement(By.name("projectDescriptionField")).sendKeys("Welcome to Project");
